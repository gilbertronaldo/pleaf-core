...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h2 class="sub-header">{{ $nameBfBt }}</h2>
            @if(isset($annotations["in"]) && count($annotations["in"]) !=1)
            ...
            @if(isset($annotations["out"]) && count($annotations["out"]) !=1)
                <div class="table-responsive">
                    <h3>Info In</h3>
                    <table class="table table-striped">
                        <thead>
