...
class CreateController extends Command
{
     ...
     * @var string
     */
    protected $signature = 'pleaf:create-controller {name?} {namespace?} {location?} {--interactive=true}';
    ...
    public function handle()
    {
        ...
        do {
	        ...
	        if($interactive){
	            ...
	            if(isset($lastInput['create-controller']) && is_array($lastInput['create-controller'])){
	            	$defaultName = $lastInput['create-controller']['name'];
	            	$defaultNamespace = $lastInput['create-controller']['namespace'];
	            	$defaultLocation = $lastInput['create-controller']['location'];
	            }

	            $name = $this->ask("What is controller name [$defaultName] ? ");
